...
export const BOOKING_SUMMARY_REQUEST = 'BOOKING_SUMMARY_REQUEST';
export const BOOKING_SUMMARY_SUCCESS = 'BOOKING_SUMMARY_SUCCESS';
export const BOOKING_SUMMARY_FAIL = 'BOOKING_SUMMARY_FAIL';
