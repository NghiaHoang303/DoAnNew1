...
const HEREMap = ({ animateCenter, animateZoom, appId, appCode, center, hidpi, interactive, secure, zoom, setLayer, children, ...rest }) => {
    ...
    const [,] = useLink('https://js.api.here.com/v3/3.0/mapsjs-ui.css?dp-version=1526040296', 'map-styles');
    const [coreLoaded] = useScript('https://js.api.here.com/v3/3.0/mapsjs-core.js', 'core');
    const [serviceLoaded] = useScript('https://js.api.here.com/v3/3.0/mapsjs-service.js', 'service');
    const [uiLoaded] = useScript('https://js.api.here.com/v3/3.0/mapsjs-ui.js', 'ui');
    const [mapeventsLoaded] = useScript('https://js.api.here.com/v3/3.0/mapsjs-mapevents.js', 'mapevents');
    ...
    React.useEffect(() => {
        if (platform) {
            ...
            if (mapElement && !map) {
                const newMap = new H.Map(mapElement, customLayer || defaultLayers.normal.map, {
                    center,
                    zoom,
    ...
    return (React.createElement(MapContext.Provider, { value: { map, behavior, ui } },
        React.createElement("div", { id: "map-container", "data-testid": "map-container", style: { height: '100%' } }, map ? children : null)));
};
